...
void* thread_func(void * ptr){
    ...
    get_client_contents(clientfd);

    pthread_exit(NULL);
}


void get_client_contents(int clientfd){
	...
	printMovies(temp_mvs, temp_total_num_of_movies,"w",file_index == 0 ?"first.csv" : "second.csv");
	file_index += 1;
